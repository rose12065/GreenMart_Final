...
if (isset($_GET['update_status']) && $_GET['update_status'] === 'true') {
    // Update the status in tbl_price
                                ...
                                while ($row = mysqli_fetch_assoc($all_addresses)) {
                                    ...
                                    <div class="d-flex flex-row pb-3">
                                        <div class="d-flex align-items-center pe-2">
                                            <input class="form-check-input shipaddress" type="radio" name="shipaddress"
                                                id="shipaddress" value="<?php echo $row['address_id'] ?>" aria-label="..." />
                                        </div>
                        ...
                        <div class="rounded d-flex flex-column p-2" style="background-color: #f8f9fa;">
                            ...
                            <div class="rounded d-flex flex-column p-2 mt-3" style="background-color: #f8f9fa;">
                                ...
                                <div class="p-2 d-flex pt-3">
                                    ...
                                    <div class="ms-auto">
                                        <button type="button" class="btn btn-secondary" name="coupon-apply" onclick="applyCoupon()">Apply</button>
                                    </div>
                                </div>
                            </div>

                            <input type="hidden" name="checkoutAmount" id="checkoutAmountInput" value="<?php echo $checkoutAmount ?>">
